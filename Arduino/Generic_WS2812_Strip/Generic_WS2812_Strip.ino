...
bool hwSwitch = false;
bool useMultiplierEntertainment = false;
...
bool saveConfig() {
  ...
  json["uem"] = useMultiplierEntertainment;
...
bool loadConfig() {
  ...
  if (json.containsKey("uem")) {
    useMultiplierEntertainment = json["uem"];
  }
...
void setup() {
  ...
  server.on("/config", []() {
    ...
    root["uem"] = useMultiplierEntertainment;
    root["useMultiplierEntertainment"] = (int)useMultiplierEntertainment;
  ...
  server.on("/", []() {
    if (server.arg("section").toInt() == 1) {
      ...
      useMultiplierEntertainment = server.hasArg("useMultiplierEntertainment") ? server.arg("useMultiplierEntertainment").toInt() : 0;
...
void entertainment() {
  ...
  if (packetSize) {
    ...
    if (useMultiplierEntertainment == true)
    {
