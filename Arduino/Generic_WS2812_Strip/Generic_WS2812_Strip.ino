          ...
          if (light == 0) {
            ...
            for (int pixel = 0; pixel < dividedLightsArray[light]; pixel++)
            {
              ...
              if (pixel < transitionLeds) {
                strip->SetPixelColor(pixel + pixelSum, blending( lights[light - 1].currentColors, lights[light].currentColors, pixel));
              } else if (pixel > lightsCount - 1) {
                strip->SetPixelColor(pixel + pixelSum, blending( lights[light].currentColors, lights[light + 1].currentColors, pixel + 1 - pixelSum));
              } else  {
